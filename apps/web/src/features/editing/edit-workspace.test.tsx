...
const models = [
  { id: "inpaint", name: "局部重绘模型", provider: "mock", model_id: "edit", base_url: null, billing_currency: "USD", provider_options: {}, capabilities: ["inpaint"], has_key: false, key_suffix: null, is_enabled: true },
  { id: "outpaint", name: "扩图模型", provider: "mock", model_id: "expand", base_url: null, billing_currency: "USD", provider_options: {}, capabilities: ["outpaint"], has_key: false, key_suffix: null, is_enabled: true },
];
