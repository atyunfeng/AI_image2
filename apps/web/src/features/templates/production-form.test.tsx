...
const products = [
  { id: "product-1", sku: "SKU-1", name: "衬衫", category: "apparel" as const },
];
const models = [
  {
    id: "model-1",
...
it("previews platform-derived slots before execution", async () => {
  vi.stubGlobal(
    ...
    vi.fn().mockResolvedValue({
      ...
      json: async () => ({
        ...
        compiled_snapshot: {
          packs: { platform: { slug: "amazon-global", version: 1 } },
        },
        items: [
          {
            id: "i1",
          ...
          },
          {
            id: "i2",
            position: 1,
            slot: "detail_material",
            label: "材质详情",
            requested_view: "detail",
            width: 2000,
            height: 2000,
            prompt: "detail",
            authoritative_copy: "材质细节",
            rules: {},
          },
        ],
      }),
  ...
  expect(screen.getByText(/材质详情 · 2000 × 2000/)).toBeVisible();
