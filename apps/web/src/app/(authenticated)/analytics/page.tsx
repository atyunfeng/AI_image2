...
export default async function AnalyticsPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <div className="space-y-7"><div><p className="eyebrow">COST & THROUGHPUT</p><h1 className="page-title">成本运营</h1><p className="mt-3 max-w-3xl text-sm leading-6 text-slate-400">成本为 Provider 回传或配置估算值，不替代服务商账单；延迟、失败和重试来自中台实际任务记录。</p></div><AnalyticsFilters values={values} />
